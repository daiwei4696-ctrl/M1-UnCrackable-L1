...
`;
  ...
  frida_java_bridge_default.perform(function() {
    var c = frida_java_bridge_default.use("sg.vantagepoint.a.c");
    c.a.implementation = function() {
      console.log("[bypass] root check c.a() -> false");
      return false;
    };
    c.b.implementation = function() {
      console.log("[bypass] root check c.b() -> false");
      return false;
    };
    c.c.implementation = function() {
      console.log("[bypass] root check c.c() -> false");
      return false;
    };
    var b = frida_java_bridge_default.use("sg.vantagepoint.a.b");
    b.a.overload("android.content.Context").implementation = function(ctx) {
      console.log("[bypass] debuggable check b.a(ctx) -> false");
      return false;
    };
    var aes = frida_java_bridge_default.use("sg.vantagepoint.a.a");
    aes.a.overload("[B", "[B").implementation = function(k, d) {
      var o = this.a(k, d);
      console.log('[*] AES decrypted secret => "' + frida_java_bridge_default.use("java.lang.String").$new(o) + '"');
      return o;
    };
  ...
  setTimeout(function() {
    frida_java_bridge_default.perform(function() {
      var Ck = frida_java_bridge_default.use("sg.vantagepoint.uncrackable1.a");
